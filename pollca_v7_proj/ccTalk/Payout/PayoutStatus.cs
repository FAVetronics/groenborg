...
{
    /// <summary>
    /// Payout coins status data.
    /// </summary>
    [Serializable]
    public struct PayoutStatus
    {
        ...
        /// <returns>
        /// A new copy of the <see cref="PayoutStatus"/> object.
        /// </returns>
        public PayoutStatus Clone()
        {
            try
            {
                ...
                return (PayoutStatus)formatter.Deserialize(ms);
            }
            catch { return this; }
        }
    }
