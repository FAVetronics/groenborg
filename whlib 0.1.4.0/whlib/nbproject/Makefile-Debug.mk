...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libwhlib.a

dist/Debug/GNU-Linux-x86/libwhlib.a: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/GNU-Linux-x86
	${RM} dist/Debug/GNU-Linux-x86/libwhlib.a
	${AR} rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libwhlib.a ${OBJECTFILES} 
	$(RANLIB) dist/Debug/GNU-Linux-x86/libwhlib.a

${OBJECTDIR}/ccTalkTwsDevice.o: nbproject/Makefile-${CND_CONF}.mk ccTalkTwsDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ccTalkTwsDevice.o ccTalkTwsDevice.cpp

${OBJECTDIR}/ccTalkBillValidatorDevice.o: nbproject/Makefile-${CND_CONF}.mk ccTalkBillValidatorDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ccTalkBillValidatorDevice.o ccTalkBillValidatorDevice.cpp

${OBJECTDIR}/MdbDevice.o: nbproject/Makefile-${CND_CONF}.mk MdbDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/MdbDevice.o MdbDevice.cpp
...
${OBJECTDIR}/CTimeOut.o: nbproject/Makefile-${CND_CONF}.mk CTimeOut.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CTimeOut.o CTimeOut.cpp

${OBJECTDIR}/ccTalkEmpDevice.o: nbproject/Makefile-${CND_CONF}.mk ccTalkEmpDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ccTalkEmpDevice.o ccTalkEmpDevice.cpp

${OBJECTDIR}/CSerCom.o: nbproject/Makefile-${CND_CONF}.mk CSerCom.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CSerCom.o CSerCom.cpp

${OBJECTDIR}/ccTalkHzwDevice.o: nbproject/Makefile-${CND_CONF}.mk ccTalkHzwDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ccTalkHzwDevice.o ccTalkHzwDevice.cpp

${OBJECTDIR}/ccTalkPayoutDevice.o: nbproject/Makefile-${CND_CONF}.mk ccTalkPayoutDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ccTalkPayoutDevice.o ccTalkPayoutDevice.cpp

${OBJECTDIR}/CccTalk.o: nbproject/Makefile-${CND_CONF}.mk CccTalk.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/CccTalk.o CccTalk.cpp

${OBJECTDIR}/MdbDispenserDevice.o: nbproject/Makefile-${CND_CONF}.mk MdbDispenserDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/MdbDispenserDevice.o MdbDispenserDevice.cpp

${OBJECTDIR}/nomination.o: nbproject/Makefile-${CND_CONF}.mk nomination.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/nomination.o nomination.cpp

${OBJECTDIR}/ccTalkCCT910Device.o: nbproject/Makefile-${CND_CONF}.mk ccTalkCCT910Device.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ccTalkCCT910Device.o ccTalkCCT910Device.cpp

${OBJECTDIR}/ccTalkCCT900Device.o: nbproject/Makefile-${CND_CONF}.mk ccTalkCCT900Device.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ccTalkCCT900Device.o ccTalkCCT900Device.cpp

${OBJECTDIR}/MdbCashlessDevice.o: nbproject/Makefile-${CND_CONF}.mk MdbCashlessDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/MdbCashlessDevice.o MdbCashlessDevice.cpp

${OBJECTDIR}/ccTalkDevice.o: nbproject/Makefile-${CND_CONF}.mk ccTalkDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ccTalkDevice.o ccTalkDevice.cpp

${OBJECTDIR}/ccTalkCisDevice.o: nbproject/Makefile-${CND_CONF}.mk ccTalkCisDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ccTalkCisDevice.o ccTalkCisDevice.cpp
